  ...
  return (
    <div className='relative bg-black-100 flex justify-center items-center flex-col overflow-hidden mx-auto sm:px-10 px-5'>
        ...
        <div className='max-w-6xl w-full h-screen flex flex-col justify-center relative'>
            <Image
                src='/images/landing_page_hero_image.svg'
            ...
            <div className='mt-4 flex flex-row gap-4'>
                <a href='/dashboard' className="hover:shadow-[0_2px_10px_rgba(0,118,255,23%)] hover:bg-slate-900 px-8 py-3 bg-slate-600 rounded-md text-white transition duration-200 ease-linear cursor-pointer">
                    Get Started!
                </a>
